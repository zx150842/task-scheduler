...
public class TransportClientFactory implements Closeable {
    ...
    public TransportClientFactory(TransportContext context) {
        ...
        this.pooledByteBufAllocator = NettyUtils.createPooledByteBufAllocator(conf.preferDirectBufs(), false, conf.clientThreads());
    }
    ...
    private TransportClient createClient(InetSocketAddress address) throws IOException {
        ...
        logger.info("Successfully created connection to {} after {} ms",
                address, (System.nanoTime() - preConnect) / 1000000);
        return client;
    }
